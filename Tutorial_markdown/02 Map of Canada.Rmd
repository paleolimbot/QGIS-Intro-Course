...
Another way to add a layer is to drag and drop from the file manager. Always drag the ".shp" file.

![Slide05](02 Map of Canada/Slide05.jpg)

### Basic Map Tools

Useful tools for getting around the map are the "pan" tool (the hand), the "zoom" tools, and the "identify" tool. Choose the "identify" tool.

![Slide06](02 Map of Canada/Slide06.jpg)

Click on one of the "features" on the map. A list of "attriutes" should appear in the QGIS window.
